...
export default function CustomToolbar({ label, onNavigate, onView, view }: CustomToolbarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between bg-[var(--color-a)] p-4 rounded-t-2xl border-b-2 border-[var(--color-c)] shadow-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-lg font-semibold text-[var(--color-e)] px-3">{label}</span>
        <button
